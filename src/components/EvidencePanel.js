  ...
  render() {
    ...
    this.innerHTML = `
      <div class="card" style="margin-bottom: var(--space-4);">
        <h4 style="font-weight: 700; font-size: var(--font-size-base); margin-bottom: var(--space-2);">Scanner Evidence (${escapeHtml(scanner) || 'Automated'})</h4>
        ${description ? `<p style="font-size: var(--font-size-sm); color: var(--color-text-secondary); margin-bottom: var(--space-2);">${escapeHtml(description)}</p>` : ''}
